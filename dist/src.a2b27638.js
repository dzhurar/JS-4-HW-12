...
function countTime(targetDate) {
  console.log("\u0427\u0430\u0441 \u0432\u0456\u0434\u0440\u0430\u0445\u043E\u0432\u0443\u0454\u0442\u044C\u0441\u044F \u0434\u043E ".concat(targetDate.toLocaleDateString('uk-UA', {
    year: 'numeric',
    month: 'long',
    day: 'numeric'
  })));
  var timer = setInterval(function () {
    ...
    if (timeLeft > 0) {
      ...
      document.querySelector('[data-value="days"]').textContent = "".concat(String(days).padStart(2, '0'));
      document.querySelector('[data-value="hours"]').textContent = "".concat(String(hours).padStart(2, '0'));
      document.querySelector('[data-value="mins"]').textContent = "".concat(String(mins).padStart(2, '0'));
      document.querySelector('[data-value="secs"]').textContent = "".concat(String(secs).padStart(2, '0'));
    } else if (timeLeft <= 0) {
      clearInterval(timer);
